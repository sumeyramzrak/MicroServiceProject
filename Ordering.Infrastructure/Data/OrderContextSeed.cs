...
namespace Ordering.Infrastructure.Data
{
    public class OrderContextSeed
    {
        ...
        {
            if(!orderContext.Orders.Any()) //OrderContext altındaki Order tablosunda herhangi bir kayıt var mı diye bak yoksa
            {
                orderContext.Orders.AddRange(GetPreconfiguredOrders()); //Seed dataları ekle
